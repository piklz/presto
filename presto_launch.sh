...
#CHECK first IF GIT INSTALLED FIRST or folder for repo exists too IF NOT, INSTALL GIT AND THEN INSTALL PRESTO
...
declare -A cont_array=(
	...
	[sonarr]="Sonarr -for your needs"
	[radarr]="Radarr for your film needs"
	[lidarr]="Lidarr for your music needs"
	[jackett]="Jackett - indexer for radarr lidaar sonar etc"
	...
	[heimdall]="heimdall all in one web page for all your *arr type frontends"
